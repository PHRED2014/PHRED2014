...
public interface RobotMap {
    ...
    public final static int MotorGearI = 1; //Motors
    
    public final static int BeltI = 1; //Belt motor
    
    public final static int GyroI = 1; //PRobably unndeeded
    
    public final static int OpticsI = 1; //Optical sensors. Put it on screen, Data
    
    public final static int LSwitchI = 1; //Limit switches
    public final static int LSwitchII = 2;
